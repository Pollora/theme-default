{{--
    The body of the "page not found" screen.

    Shared by the two templates that need it, because WordPress and the older
    skeletons ask for it under different names — see 404.blade.php.
--}}
